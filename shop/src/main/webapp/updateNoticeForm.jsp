				...
				<div class="container" style="background-color: #fff;">
					<form action="<%=request.getContextPath()%>/updateNoticeAction.jsp" method="post">
						<table class="table table-bordered">
							...
							<tr>
								<td><h5>Title</h5></td>
								<td colspan="3"><h5><input type="text" name="noticeTitle" value="<%=notice.getNoticeTitle()%>"></h5></td>
							</tr>
							<tr>
								<td><h5>Content</h5></td>
								<td colspan="3"><input type="text" name="noticeContent" value="<%=notice.getNoticeContent()%>"></td>
							</tr>
							<tr>
						...
						<div style="float: right;">
							...
							<a href="<%=request.getContextPath()%>/adminNoticeOne.jsp?noticeNo=<%=notice.getNoticeNo()%>" class="btn btn-dark">CANCEL</a>	
						</div>
					</form>
				</div>
			</div>
