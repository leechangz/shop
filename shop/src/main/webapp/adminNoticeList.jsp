...
<%@ include file="/WEB-INF/view/header.jsp"%>	
	<div class="container text-center">
		<div class="jumbotron text-center" style="background-image: url(<%=request.getContextPath()%>/images/employee.JPG); height: 200px; magin: auto;">
			...
			<h3 style="color: #fff;">NOTICE LIST</h3>
		</div>
		<div class="row">
			<div class="col-sm-2">
				...
				<table class="table table-bordered">
					...
					%>
							<tr>
								<td><%=n.getNoticeNo()%></td>
								<td>
									<a href="<%=request.getContextPath()%>/adminNoticeOne.jsp?noticeNo=<%=n.getNoticeNo()%>">
										<%=n.getNoticeTitle()%>
									</a>
								</td>
		...
		<div>
			<a href="<%=request.getContextPath()%>/adminAddNoticeForm.jsp" class="btn btn-dark" style="float: right;">INSERT</a>
		</div>
		<div>
		<!-- 페이지 -->
			<ul class="pagination justify-content-center">
				...
				<%
					if(currentPage > 1) {
				%>	
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/adminNoticeList.jsp?currentPage=<%=currentPage-1%>">이전</a></li>
				<%
					}
				%>
				...
				%>
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/adminNoticeList.jsp?currentPage=<%=i%>"><%=i%></a></li>
				<%
					}
				%>
				<!-- 다음 -->
				...
				%>	
						<li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/adminNoticeList.jsp?currentPage=<%=currentPage+1%>">다음</a></li>
				<%
					}
				%>
			</ul>
